...
public class ShareService: ObservableObject {
    ...
    public func sharePrayerGuide(
        ...
        let shareContent = ShareContent.prayerGuide(title: title, content: content)
        shareContent(shareContent, from: sourceView)
    }
    ...
    public func sharePrayerTimes(
        ...
        let shareContent = ShareContent.prayerTimes(times: times, location: location)
        shareContent(shareContent, from: sourceView)
    }
