...
public extension ColorPalette {
    ...
    // Note: accessibleTextPrimary and accessibleBackground are now defined in the main ColorPalette struct
}
...
public struct AccessibleText: View {
    ...
    public init(
        ...
        self.text = text
        self.style = style
        self.color = color // Will be resolved at runtime with @MainActor
    }
