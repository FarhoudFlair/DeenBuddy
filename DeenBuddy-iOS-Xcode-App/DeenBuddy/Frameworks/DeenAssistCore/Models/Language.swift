...
public struct AppLanguage: Codable, Identifiable, Equatable, Hashable, Sendable {
...
public enum TextDirection: String, Codable, CaseIterable, Sendable {
...
/// Language regions
public enum LanguageRegion: String, Codable, CaseIterable, Sendable {
...
public enum CalendarType: String, Codable, CaseIterable, Sendable {
...
public struct PrayerNames: Codable, Equatable, Hashable, Sendable {
