...
public struct AccessibilityHelpers {
    ...
    public static func prayerTimeLabel(prayer: PrayerTimeType, time: Date) -> String {
...
public extension View {
    ...
    func prayerTimeAccessibility(prayer: PrayerTimeType, time: Date) -> some View {
        self
    ...
    func accessibilityAnnouncement(_ text: String, priority: String = "medium") -> some View {
        self.onAppear {
